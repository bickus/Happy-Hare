...
OTHER_STEPPER_PARAMS     = ['step_pin', 'dir_pin', 'enable_pin', 'endstop_pin', 'rotation_distance', 'pressure_advance', 'pressure_advance_smooth_time', 'nozzle_diameter','filament_diameter','pressure_advance_model','linear_advance','nonlinear_offset','linearization_velocity','pressure_advance_time_offset']
    ...
    def handle_connect(self):
        ...
        if self.mmu_machine.homing_extruder:
            ...
            for key, value in self.old_ext_options.items():
                ...
                logging.info("MmuExtruderStepper: %s=%s" % (key,value))
            ...
            self.mmu_extruder_stepper = printer_extruder.get_extruder_steppers()[0]
